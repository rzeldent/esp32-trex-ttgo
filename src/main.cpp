...
PROGMEM unsigned char enemies[2][684] = {
...
void setup()
{
  ...
  img.setColorDepth(1);
  sprite_dino.setColorDepth(1);
  sprite_enemy1.setColorDepth(1);
  sprite_enemy2.setColorDepth(1);

  img.createSprite(240, 100);
  sprite_dino.createSprite(33, 35);
  sprite_enemy1.createSprite(eW, eH);
  sprite_enemy2.createSprite(eW, eH);
  tft.fillScreen(TFT_WHITE);
...
void drawS(int x, int y, int frame)
{
  ...
  sprite_enemy1.drawXBitmap(0, 0, enemies[0], eW, eH, TFT_BLACK, TFT_WHITE);
  sprite_enemy2.drawXBitmap(0, 0, enemies[1], eW, eH, TFT_BLACK, TFT_WHITE);
  sprite_dino.drawXBitmap(0, 0, dino[frame], 33, 35, TFT_BLACK, TFT_WHITE);
